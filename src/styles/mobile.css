...
@media (max-width: 767px) {
  ...
  #expertise {
    ...
    /* Increased from clamp(5rem, 14vw, 8rem) -- same logic as #about
       above. Services cards need to finish on full navy before the
       bleed walk to white begins. Extra padding gives the bleed room
       to complete in transition space, not during services content view. */
    padding-block-end: clamp(8rem, 20vw, 14rem);
  }
